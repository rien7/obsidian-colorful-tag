...
export default class ColorfulTag extends Plugin {
	...
	addPopupCss(tag: string) {
		...
		css += `.colorful-tag-popup-body { padding: 0 10px; border: 4px solid ${background_color}; border-radius: 0 0 10px 10px; border-top: none; background-color: var(--background-primary-alt); }`;
